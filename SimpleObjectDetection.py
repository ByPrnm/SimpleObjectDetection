...
def process_image(image, canny_low, canny_high, threshold_val, min_area, max_area):
    ...
    binary_image = gray_image < threshold_val # Buat binary mask dari threesholding
    ...
    return gray_image, edges, final_mask, detected_image
...
def interactive_detection():
    ...
    gray, edges, binary, detected = process_image(image, init_canny_low, init_canny_high, init_threshold_val, init_min_area, init_max_area)
    ...
    ax[2].set_title('Detected Object')
    ...
    def update(val=None):
        gray, edges, binary, detected = process_image(
            image,
            s_canny_low.val,
            s_canny_high.val,
            s_threshold.val,
